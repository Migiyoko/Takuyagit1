...
hyperparameters_decode= {'de_filter':[[2,2],[3,3],[5,5]],
                         'de_size':[z_dimension,64,256,784],
                          'de_activation':['relu','relu','relu'],
                          'names':['de_layer_1', 'de_layer_2', 'de_layer_out']}
hyperparameters_scope={'learning_late':0.0005, 'maxEpoch':200, 'batch_size':512}
...
with tf.variable_scope(tf.get_variable_scope()):
    ...
    do1 = dropout(c1, name='do1',keep_prob=0.9)
    c2=conv2d(do1, name='c2', kshape=hyperparameters_encode['en_filter'][1])
    do2 = dropout(c2, name='do2', keep_prob=0.9)
    print(do2)
